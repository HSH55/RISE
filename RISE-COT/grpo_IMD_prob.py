...
from trainer import Qwen2VLGRPOTrainer_class,Qwen2VLGRPOVLLMTrainer,Qwen2VLGRPOTrainer_IMD_prob
...
def main(script_args, training_args, model_args):
    ...
    trainer_cls = Qwen2VLGRPOTrainer_IMD_prob if not training_args.use_vllm else Qwen2VLGRPOVLLMTrainer
