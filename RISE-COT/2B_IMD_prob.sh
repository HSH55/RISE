...
export DATA_PATH="/dataset/IMN/IMN_problist_20cls25_2stage"
export CKPT_PATH="/share_models/Qwen2-VL-2B-Instruct"
export SAVE_PATH="/share_models/Qwen2-VL-2B-Instruct_IMN_prob"
...
torchrun --nproc_per_node=8 \
    ...
    --max_pixels 401408 \
    --num_train_epochs 1 \
    --run_name Qwen2-VL-2B-Instruct_imd\
    --num_generations 8 \
    --save_steps 10 \
