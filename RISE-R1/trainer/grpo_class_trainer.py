...
class Qwen2VLGRPOTrainer_class_think(Trainer):
    """
    ...
    def __init__(
        ...
        if self.ref_model is not None:
            if self.is_deepspeed_enabled:
                ...
                self.ref_model = self.accelerator.prepear_model(self.ref_model, evaluation_mode=True)
    ...
    def compute_loss(self, model, inputs, return_outputs=False, num_items_in_batch=None):
        ...
        for ex,completion in zip(inputs,completions):
            ...
            new_completions.append([{"role": "assistant", "content": completion}])
